...
const sendMarsTemperature = (temperatureInFahrenheit) =>
  setTimeout(() => temperatureInFahrenheit(getMarsTemperature(), messageDelay())); // imprime "It is currently 47ºF at Mars", por exemplo
